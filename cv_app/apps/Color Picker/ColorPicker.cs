...
namespace OpenCVForUnityExample
{
    ...
    public class ColorPicker : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                RectTransform rt = imgMask.GetComponent<RectTransform>();
        ...
        public void OnWebCamTextureToMatHelperInitialized()
        {
            ...
            ///// Custom Code /////////
            textureMask = new Texture2D(webCamTextureMat.cols(), webCamTextureMat.rows(), TextureFormat.RGBA32, false);
        ...
        void Update()
        {
            if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
            {
                ...
                Core.inRange(imgHSV, new Scalar(hMin.value, sMin.value, vMin.value),
                    new Scalar(hMax.value, sMax.value, vMax.value), mask);
                ////////////////////////////////////

                Utils.matToTexture2D(img, texture);
                Utils.matToTexture2D(mask, textureMask);

                inputImage.texture = texture;
                imgMask.texture = textureMask;
            }
        }
